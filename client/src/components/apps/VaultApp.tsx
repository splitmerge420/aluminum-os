...
const artifacts: Artifact[] = [
  ...
  {
    id: "alum-int-007",
    title: "ALUM-INT-007: Sheldonbrain ↔ Aluminum OS Constitutional Integration Spec",
    shortTitle: "ALUM-INT-007",
    description: "Claude's constitutional integration specification fusing sheldonbrain as the knowledge substrate of Aluminum OS. 7 modules rewritten, 8 invariants enforced, 5-layer architecture mapping, Janus↔Council bridging.",
    category: "Architecture",
    icon: "🧬",
    color: "#06b6d4",
    url: "#",
    date: "2026-03-15",
    status: "active",
    tags: ["SHELDONBRAIN", "Integration", "Constitutional", "ALUM-INT-007", "Claude"],
    provider: "Claude",
  },
  {
    id: "constitutional-ontology",
    title: "ConstitutionalOntologyManager — Sphere 144 Ghost Seat, Consent Scopes",
    shortTitle: "Ontology Manager",
    description: "Rewritten OntologyManager with Sphere 144 reserved as Ghost Seat (human-collective override), consent_scope metadata, PQC-signed classification decisions, and health-sphere elevated sensitivity defaults.",
    category: "Architecture",
    icon: "🧠",
    color: "#06b6d4",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["Ontology", "Ghost Seat", "Sphere 144", "INV-1", "INV-3"],
    provider: "Claude",
  },
  {
    id: "constitutional-vault",
    title: "ConstitutionalVaultManager — HIPAA PII Detection, ConsentProof Tokens",
    shortTitle: "Vault Manager",
    description: "Rewritten VaultManager requiring ConsentProof tokens for all operations. HIPAA-specific PII patterns (MRN, ICD-10, NPI), destination-based exposure policy, HIPAA/GDPR sensitivity tiers.",
    category: "Architecture",
    icon: "🔐",
    color: "#8b5cf6",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["Vault", "HIPAA", "ConsentProof", "PQC", "INV-2", "INV-14"],
    provider: "Claude",
  },
  {
    id: "constitutional-ingestion",
    title: "ConstitutionalIngestionPipeline — Consent-Gated, Council Consensus Filtering",
    shortTitle: "Ingestion Pipeline",
    description: "Consent-gated ingestion pipeline with sphere classification before staging, Council consensus significance filtering (not single-model), PQC-signed receipts, and FHIR/wearable/PubMed health connectors.",
    category: "Architecture",
    icon: "📥",
    color: "#f59e0b",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["Ingestion", "Consent", "Council", "FHIR", "INV-2", "INV-7"],
    provider: "Claude",
  },
  {
    id: "constitutional-janus",
    title: "ConstitutionalJanusProtocol — 5-Phase Multi-Model, Ghost Seat Override",
    shortTitle: "Janus Protocol",
    description: "5-phase Janus Protocol: Router (INV-7), Deep Think (multi-model), Resonance (constitutional constraints), Reality Sync (PQC provenance), Constitutional Audit (new Phase 5). Ghost Seat invocable at Phase 3.",
    category: "Protocol",
    icon: "⚡",
    color: "#ef4444",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["Janus", "Multi-Model", "Ghost Seat", "INV-7", "INV-8", "Phase 5"],
    provider: "Claude",
  },
  {
    id: "constitutional-vectorstore",
    title: "ConstitutionalVectorStore — Lattice Role Access, Consent-Gated Search",
    shortTitle: "Vector Store",
    description: "Vector store with access levels aligned to Lattice node roles (SOVEREIGN, DELEGATE, EDGE, WITNESS, RELAY). Consent-gated search, PQC-sealed metadata, sphere-scoped collections, encryption at rest.",
    category: "Architecture",
    icon: "🗄️",
    color: "#10b981",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["VectorStore", "Lattice", "Consent", "INV-3", "INV-14", "INV-27"],
    provider: "Claude",
  },
  {
    id: "constitutional-rag",
    title: "ConstitutionalRAGPipeline — Vault-Aware, Multi-Model, PII-Filtered",
    shortTitle: "RAG Pipeline",
    description: "Constitutional RAG with ConsentKernel query routing, vault consent proofs, Council consensus answer generation, constitutional provenance citations, and mandatory PII filtering on all outputs.",
    category: "Architecture",
    icon: "🔍",
    color: "#ec4899",
    url: "#",
    date: "2026-03-15",
    status: "complete",
    tags: ["RAG", "Consent", "PII", "Multi-Model", "INV-2", "INV-3"],
    provider: "Claude",
  },
  {
    id: "health-connectors",
    title: "Health Data Connectors — FHIR, Wearable, PubMed, FDA, CDC",
    shortTitle: "Health Connectors",
    description: "5 new health data connectors: FHIRConnector (R4 patient records), WearableConnector (Apple Health/Fitbit/Garmin), PubMedConnector (evidence grading), FDAConnector (drug safety), CDCConnector (outbreak tracking). All enforce HIPAA minimum necessary.",
    category: "Integration",
    icon: "🏥",
    color: "#14b8a6",
    url: "#",
    date: "2026-03-15",
    status: "active",
    tags: ["FHIR", "Wearable", "PubMed", "FDA", "CDC", "HIPAA", "INV-3"],
    provider: "Claude",
  },
  {
    id: "interop-2026-spec",
    title: "Interop 2026 — Cross-Browser Compliance Mapping",
    shortTitle: "Interop 2026",
    description: "20 focus areas from Apple, Google, Microsoft, Mozilla, and Igalia mapped to Aluminum OS cross-platform strategy. 9 compliant, 5 partial, 5 planned, 1 monitoring. Constitutional alignment verified for all features.",
    category: "Specification",
    icon: "🌐",
    color: "#06b6d4",
    ...
    date: "2026-03-15",
    status: "active",
    tags: ["Interop 2026", "Cross-Browser", "WebKit", "20 Focus Areas", "Compliance"],
    provider: "Manus",
  },
  {
    id: "interop-anchor-positioning",
    title: "Anchor Positioning — Dock/Context Menu/Window Controls",
    shortTitle: "Anchor Positioning",
    description: "CSS Anchor Positioning (carryover from Interop 2025) mapped to Aluminum OS Dock tooltips, context menus, window controls, Agent Shell autocomplete. INV-8 human override UI must be reliably positioned.",
    category: "Specification",
    icon: "🎯",
    color: "#06b6d4",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "complete",
    tags: ["Anchor", "CSS", "Dock", "Context Menu", "INV-8"],
    provider: "Manus",
  },
  {
    id: "interop-view-transitions",
    title: "View Transitions — App Switching & Boot Sequence Animations",
    shortTitle: "View Transitions",
    description: "Cross-document and same-document view transitions for app switching animations, boot sequence to desktop transition, Council session transitions. Critical priority for UX continuity.",
    category: "Specification",
    icon: "🎬",
    color: "#0891b2",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "active",
    tags: ["View Transitions", "Animation", "App Switching", "Boot"],
    provider: "Manus",
  },
  {
    id: "interop-webtransport",
    title: "WebTransport — Real-Time Multi-Model Streaming",
    shortTitle: "WebTransport",
    description: "HTTP/3-based bidirectional transport for real-time Council deliberation streaming (10 models), SHELDONBRAIN live vector updates, health telemetry, PQC-signed audit event streaming. INV-27 alignment.",
    category: "Specification",
    icon: "⚡",
    color: "#f472b6",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "active",
    tags: ["WebTransport", "HTTP/3", "Streaming", "Council", "INV-27"],
    provider: "Manus",
  },
  {
    id: "interop-jspi-wasm",
    title: "JSPI for WASM — PQC Cryptography Performance",
    shortTitle: "JSPI WASM",
    description: "JavaScript Promise Integration for WebAssembly enables efficient async interop for Lattice Genesis PQC cryptography (Rust-WASM ML-DSA-87), sovereign_cap.rs enforcement, SHELDONBRAIN vector operations.",
    category: "Specification",
    icon: "🔐",
    color: "#a855f7",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "active",
    tags: ["JSPI", "WASM", "PQC", "ML-DSA-87", "Rust", "INV-27"],
    provider: "Manus",
  },
  {
    id: "interop-dialog-consent",
    title: "Dialog & Popover — Constitutional Consent Dialogs",
    shortTitle: "Dialog Consent",
    description: "closedby attribute for consent dialogs (INV-2), popover='hint' for governance tooltips, :open pseudo-class. Healthcare consent dialogs require closedby='none' to prevent accidental dismissal.",
    category: "Specification",
    icon: "🛡️",
    color: "#3b82f6",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "complete",
    tags: ["Dialog", "Popover", "Consent", "INV-2", "INV-8", "closedby"],
    provider: "Manus",
  },
  {
    id: "interop-navigation-api",
    title: "Navigation API — OS-Level Deep Linking",
    shortTitle: "Navigation API",
    description: "Modern replacement for history API. Enables alum:// deep linking (e.g., alum://governance/rule/INV-7), back/forward between apps, state preservation across app switches. Critical for OS-level navigation.",
    category: "Specification",
    icon: "🧭",
    color: "#0ea5e9",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "active",
    tags: ["Navigation", "Deep Linking", "alum://", "State", "History"],
    provider: "Manus",
  },
  {
    id: "interop-contrast-color",
    title: "contrast-color() — Constitutional Accessibility",
    shortTitle: "contrast-color()",
    description: "Browser auto-picks black/white text for highest contrast. Serves INV-1 patient sovereignty — medical data must be readable. Council member badges, trust scores, constitutional rule severity all benefit.",
    category: "Specification",
    icon: "👁️",
    color: "#ec4899",
    url: "https://webkit.org/blog/17818/announcing-interop-2026/",
    date: "2026-03-15",
    status: "complete",
    tags: ["contrast-color", "Accessibility", "INV-1", "WCAG", "Auto-contrast"],
    provider: "Manus",
  },
];
